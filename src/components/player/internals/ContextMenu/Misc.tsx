...
export function Title(props: { children: React.ReactNode; rightSide?: React.ReactNode }) {
  return (
    <div>
...
export function Anchor(props: { children: React.ReactNode; onClick: () => void }) {
  return (
    <a type="button" className="text-video-context-type-accent cursor-pointer" onClick={props.onClick}>
      {props.children}
    </a>
  );
}
...
export function Paragraph(props: { children: React.ReactNode; marginClass?: string }) {
...
export function TextDisplay(props: { children: React.ReactNode; title?: string; noIcon?: boolean }) {
  return (
    <div className="w-full h-full flex justify-center items-center text-center">
      <div className="flex items-center gap-4 flex-col">
        ...
        {props.title ? <h2 className="text-white text-lg font-bold">{props.title}</h2> : null}
