...
export function BrandPill(props: { clickable?: boolean; hideTextOnMobile?: boolean; backgroundClass?: string }) {
  ...
  return (
    <div
      ...
      <span className={["font-semibold text-white", props.hideTextOnMobile ? "hidden sm:block" : ""].join(" ")}>{t("global.name")}</span>
    </div>
  );
}
