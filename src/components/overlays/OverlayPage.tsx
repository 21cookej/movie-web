...
export function OverlayPage(props: Props) {
  ...
  if (backwards === "yes" || backwards === "no") animation = backwards === "yes" ? "slide-full-left" : "slide-full-right";

  return (
    <Transition animation={animation} className="absolute inset-0" durationClass="duration-[400ms]" show={show}>
      <div
