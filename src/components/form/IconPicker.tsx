...
const icons = [UserIcons.USER_GROUP, UserIcons.COUCH, UserIcons.MOBILE, UserIcons.TICKET, UserIcons.HANDCUFFS];
export const initialIcon = icons[0];

export function IconPicker(props: { label: string; value: UserIcons; onInput: (v: UserIcons) => void }) {
  return (
          ...
          return (
            <button
              ...
              className={classNames(
                ...
                props.value === icon ? "bg-buttons-purple border-white" : "bg-authentication-inputBg border-transparent",
              )}
