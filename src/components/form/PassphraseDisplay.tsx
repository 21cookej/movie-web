  ...
  return (
    <div className="rounded-lg border border-authentication-border/50 ">
      <div className="px-4 py-2 flex justify-between border-b border-authentication-border/50">
        <p className="font-bold text-sm text-white">{t("auth.generate.passphraseFrameLabel")}</p>
        <button
          type="button"
          ...
          <Icon icon={hasCopied ? Icons.CHECKMARK : Icons.COPY} className={hasCopied ? "text-xs" : ""} />
