import { APP_VERSION, BACKEND_URL, DISCORD_LINK, DONATION_LINK, GITHUB_LINK } from "./constants";
...
const env: Record<keyof Config, undefined | string> = {
  ...
  ONBOARDING_CHROME_EXTENSION_INSTALL_LINK: import.meta.env.VITE_ONBOARDING_CHROME_EXTENSION_INSTALL_LINK,
  ONBOARDING_FIREFOX_EXTENSION_INSTALL_LINK: import.meta.env.VITE_ONBOARDING_FIREFOX_EXTENSION_INSTALL_LINK,
  ONBOARDING_PROXY_INSTALL_LINK: import.meta.env.VITE_ONBOARDING_PROXY_INSTALL_LINK,
...
export function conf(): RuntimeConfig {
  return {
    ...
    ONBOARDING_CHROME_EXTENSION_INSTALL_LINK: getKey(
      ...
      "https://gh.micromatrix.org/https://github.com/FreeServiceSource/movie-web-extension/releases/download/1.1.4/extension-mw.chrome.zip",
    ),
